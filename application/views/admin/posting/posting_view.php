            ...
            "columnDefs":[
               ...
               
                {
                    "targets": 7,
                        ...
                        return '<a class="btn btn-xs btn-success" href="<?php echo base_url(); ?>admin/posting/' + halaman + '/edit/' + row[1] + '"><span class="glyphicon glyphicon-pencil"></span> Edit </a><a class="btn btn-xs btn-danger" href="<?php echo base_url(); ?>admin/posting/hapus/' + row[1] + '"><span class="glyphicon glyphicon-remove"></span> Hapus</a>';  
                        }
                },
            ],
            "searchCols": [
