...
<div class="col-lg-12" style="background-color:white;">
    ...
    <div style="background-color:white;">
        <?php echo form_open_multipart('public/Curhat/edit_post/'.$data->id_post);?>
         <!-- pilih file 
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="judulCurhat" id="judulCurhat" value="<?php echo $data->judul_post ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <input name="teksCurhat" id="teksCurhat" type="hidden" value=" <?php echo $data->konten_post ?>">     
            <button class="btn btn-primary" type="submit">Edit Curhat!</button>
        </div>         
