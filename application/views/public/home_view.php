    ...
    <div class="col-lg-12">
        ...
        <div id="panel-post-terkini" class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="list-berita list-group">
                    <ul>
                        <li class="list-group-item">
                            <h4>Judul Berita</h4>
                            <p>teks berita</p>
                            <p style="font-size:10px">dipost tanggal 21 Agustus 2017 oleh <b>Admin</b></p>
                        </li>
                        <li class="list-group-item">
                            <h4>Judul Berita</h4>
                            <p>teks berita</p>
...
-->
        ...
        <span class="glyphicon glyphicon-chevron-right"></span>
            ...
            <!--div id="list-group-berita" class="list-berita list-group col-sm-4">

                            <ul>
                                <li data-target="#carousel-example-generic" data-slide-to="0" class="list-group-item active">
                                    <a href="#">
                                        <h4>Lorem ipsum dolor sit amet consetetur sadipscing</h4>
                                    </a>
                                </li>
                                <li data-target="#carousel-example-generic" data-slide-to="1" class="list-group-item">
                                    <a href="#">
                                        <h4>consetetur sadipscing elitr, sed diam nonumy eirmod</h4>
                                    </a>
                                </li>
                                <li data-target="#carousel-example-generic" data-slide-to="2" class="list-group-item">
                                    <a href="#">
                                        <h4>tempor invidunt ut labore et dolore</h4>
                                    </a>
                                </li>
                                <li data-target="#carousel-example-generic" data-slide-to="3" class="list-group-item">
                                    <a href="#">
                                        <h4>magna aliquyam erat, sed diam voluptua</h4>
                                    </a>
                                </li>
                                <li data-target="#carousel-example-generic" data-slide-to="4" class="list-group-item">
                                    <a href="#">
...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="responsiveTabs panel panel-default">
            <ul id="" class="myTab panel-heading nav nav-tabs" style="margin-bottom: 15px;">
                <li role="presentation"><a href="#berita" data-toggle="tab">Berita</a></li>
                <li class="active"><a href="#karir" data-toggle="tab">Karir</a></li>
                <li><a href="#pers" data-toggle="tab">Pers</a></li>
            </ul>
            <div id="" class="myTabContent tab-content">
                <div class="tab-pane fade" id="berita">
                    <ul class="list-group">
                        <li class="list-group-item">
                            <a href="#">Item 1</a>
                            <p class="keterangan">Dipost tanggal 21 Agustus 2017</p>
                        </li>
                        <li class="list-group-item">Item 2</li>
                        <li class="list-group-item">Item 3</li>
                    </ul>
                </div>
                <div class="tab-pane fade in active" id="karir">
                    <ul class="list-group">
                ...
                <div class="tab-pane fade" id="files">
                    <ul class="list-group">
                        <?php
                            ...
                            ?>
                            <li class="list-group-item"><?php echo $record->nama_file ?>
                                <p style="font-size: 10px">Diposting <?php echo date('j F Y',strtotime($record->upload_time)); ?> oleh Admin</p>
                            </li>
                        <?php $no++;
                    endforeach; ?>
                    </ul>
            ...
            ! function ($) {
                ...
                TabCollapse.prototype.showTabs = function () {
                    ...
                    $panelHeadings.each(function () {
                        ...
                        if ($parentLi.parent().hasClass('dropdown-menu') && !$parentLi.siblings('li').hasClass(
                                'active')) {
                ...
                TabCollapse.prototype.showAccordion = function () {
                    ...
                    $headings.each(function () {
                        ...
                        view.$accordion.append(view._createAccordionGroup(view.$accordion.attr('id'),
                            $heading.detach()));
                    });
                ...
                TabCollapse.prototype._initAccordion = function () {
                    ...
                    this.$accordion = $('<div class="panel-group ' + this.options.accordionClass + '" id="' +
                        accordionId + '"></div>');
                ...
                TabCollapse.prototype._createAccordionGroup = function (parentId, $heading) {
                    ...
                    $panel.find('.panel-heading > .panel-title').append(this._tabHeadingToPanelHeading($heading,
                        groupId, parentId, active));
